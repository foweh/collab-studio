...
| 编号 | 状态 | Commit | 说明 |
|------|------|--------|------|
| P0-1 | [x] | 82450a0 | 私有项目不再进入同步广播(主版 2 处 + installer 14 处) |
| P0-2 | [x] | 9298086 | project-restore 权限校验 |
| P0-3 | [x] | 2becbf5 | chat-get-history 权限加固(key 碰撞防护) |
| P0-4 | [x] | e31f2db | AI 三端点限流(IP 5/分) |
| P1-5 | [x] | c7b41d2 | sync-build.js 结束三份漂移,hash 一致 |
| P1-6 | [x] | c7b41d2 | installer 补齐(--data-dir/AI/音乐代理) |
| P1-7 | [x] | 34a909e | 会话 token 持久化 data/tokens.json |
| P1-8 | [x] | 3237d36 | 横幅管理员名读配置 |
| P1-9 | [x] | 1fb2f6c | 审批请求落盘 + 作用域 bug 修复 |
| P2-10 | [x] | 895d35f | HTTPS 自签名证书脚本 |
| P2-11 | [x] | a314448 | 剪映路径可配置 |
| P2-12 | [x] | c71e4c3 | 白板按房间持久化 |
| P2-13 | [x] | 2265874 | 音乐代理白名单(SSRF 防护) |
| P2-14 | [x] | 53f6672 | 魔法数字集中 |
| P2-15 | [x] | 48d829c | README 补齐 |

> 基线提交: `6a7639a`(.gitignore) `8c25115`(任务 MD) `bd9323a`(历史遗留改动基线,112 文件)
> 最终冒烟: 7/7 通过(登录/建项目/私聊/权限/白板/AI端点/剪映端点); 三份 server.js SHA-256 一致(`9d3bff04`)
